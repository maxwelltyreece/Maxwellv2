...
export default function Home() {
  ...
  return (
    <div className="grid grid-cols-2">
      <div className="grid content-center gap-y-2 px-10">
        ...
        <p>Outside of studies, I am a student athlete, a semi-professional drummer,</p>
        <p>and I also play a lot of video games.</p>
